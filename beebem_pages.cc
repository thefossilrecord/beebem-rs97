...
typedef struct {
	...
	EG_Widget	*lbl_l, *but_l;
	EG_Widget	*lbl_r, *but_r;

	EG_Widget	*lbl_select, *but_select;

	EG_Widget	*lbl_volup, *but_volup;
	EG_Widget	*lbl_voldown, *but_voldown;	
	...
	EG_Widget	*lbl_f_click, *but_f_click;
	...
	EG_Widget	*lbl_f_l, *but_f_l;
	EG_Widget	*lbl_f_r, *but_f_r;

	EG_Widget	*lbl_f_select, *but_f_select;

	EG_Widget	*lbl_f_volup,   *but_f_volup;
	EG_Widget	*lbl_f_voldown, *but_f_voldown;	
...
static void GameOptions1_Callback_Flip(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
...
static void GameOptions1_Callback_Cursor(EG_Widget*, void* /* user_p */)
{
	//BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
...
//	r = (SDL_Rect) {16, 16+8, GUI_WIDTH-32, GUI_HEIGHT-32-16};
 r = (SDL_Rect) {0,0, GUI_WIDTH, GUI_HEIGHT};
	...
	gui_p->game_options_1.lbl_speed = EG_Label_Create("game_options_1_speed_lbl", EG_COLOR_ALT
	 , EG_LABEL_ALIGN_CENTER, "Clock speed (MHZ):", C_1_1(r2, 1, 2));
	...
	gui_p->game_options_1.rgp_speed = EG_RadioGroup_Create("game_options_1_speed_rgp");

	gui_p->game_options_1.rbt_speed_150 = EG_ToggleButton_Create(
	 "game_options_1_speed_150", c, "170", C_1_5(r3, 1, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_150, GameOptions1_Callback_Speed, (void*) 170);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_150);

	gui_p->game_options_1.rbt_speed_160 = EG_ToggleButton_Create(
	 "game_options_1_speed_160", c, "180", C_2_5(r3, 1, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_160, GameOptions1_Callback_Speed, (void*) 180);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_160);

	gui_p->game_options_1.rbt_speed_170 = EG_ToggleButton_Create(
	 "game_options_1_speed_170", c, "190", C_3_5(r3, 1, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_170, GameOptions1_Callback_Speed, (void*) 190);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_170);

	gui_p->game_options_1.rbt_speed_180 = EG_ToggleButton_Create(
	 "game_options_1_speed_180", c, "200", C_4_5(r3, 1, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_180, GameOptions1_Callback_Speed, (void*) 200);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_180);

	gui_p->game_options_1.rbt_speed_190 = EG_ToggleButton_Create(
	 "game_options_1_speed_190", c, "210", C_5_5(r3, 1, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_190, GameOptions1_Callback_Speed, (void*) 210);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_190);

	gui_p->game_options_1.rbt_speed_200 = EG_ToggleButton_Create(
	 "game_options_1_speed_200", c, "220", C_1_5(r3, 4, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_200, GameOptions1_Callback_Speed, (void*) 220);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_200);

	gui_p->game_options_1.rbt_speed_210 = EG_ToggleButton_Create(
	 "game_options_1_speed_210", c, "230", C_2_5(r3, 4, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_210, GameOptions1_Callback_Speed, (void*) 230);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_210);

	gui_p->game_options_1.rbt_speed_220 = EG_ToggleButton_Create(
	 "game_options_1_speed_220", c, "240", C_3_5(r3, 4, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_220, GameOptions1_Callback_Speed, (void*) 240);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_220);

	gui_p->game_options_1.rbt_speed_230 = EG_ToggleButton_Create(
	 "game_options_1_speed_230", c, "250", C_4_5(r3, 4, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_230, GameOptions1_Callback_Speed, (void*) 250);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_230);

	gui_p->game_options_1.rbt_speed_240 = EG_ToggleButton_Create(
	 "game_options_1_speed_240", c, "260", C_5_5(r3, 4, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.rbt_speed_240, GameOptions1_Callback_Speed, (void*) 260);
	EG_RadioGroup_AddButton(gui_p->game_options_1.rgp_speed
	 , gui_p->game_options_1.rbt_speed_240);



	(void) EG_Window_AddWidget(gui_p->game_options_1.win, gui_p->game_options_1.rgp_speed);
	...
	/* Flipped mode tickbox:
	 */
	gui_p->game_options_1.tck_flipped = EG_TickBox_Create("game_options_1_flipped", c, "Use flipped mode (A, B, X & Y become a d-pad).", C_1_1(r3, 4, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.tck_flipped, GameOptions1_Callback_Flip, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_1.win, gui_p->game_options_1.tck_flipped);

	gui_p->game_options_1.tck_cursor = EG_TickBox_Create("game_options_1_cursor", c, "Disable hardware cursor.", C_1_1(r3, 4+3, 3) );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_1.tck_cursor, GameOptions1_Callback_Cursor, gui_p);
...
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_1.rbt_scaling_top	, gui_p->game_options_1.rbt_speed_200);
...
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_1.rbt_scaling_centered	, gui_p->game_options_1.rbt_speed_210);
...
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_1.rbt_scaling_bottom	, gui_p->game_options_1.rbt_speed_230);
...
static void GameOptions2_MapKeyNames(BeebEm_Pages *gui_p)
{
	...
	EG_Button_SetCaption(gui_p->game_options_2.but_left, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_LEFT) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_right, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_RIGHT) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_up, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_UP) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_down, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_DOWN) ) );

	EG_Button_SetCaption(gui_p->game_options_2.but_click, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_CLICK) ) );

	EG_Button_SetCaption(gui_p->game_options_2.but_a, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_A) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_b, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_B) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_x, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_X) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_y, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_Y) ) );

	EG_Button_SetCaption(gui_p->game_options_2.but_l, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_L) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_r, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_R) ) );

	EG_Button_SetCaption(gui_p->game_options_2.but_select, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_BUTTON_SELECT) ) );
	...
	EG_Button_SetCaption(gui_p->game_options_2.but_f_left, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_LEFT) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_f_right, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_RIGHT) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_f_up, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_UP) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_f_down, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_DOWN) ) );

	EG_Button_SetCaption(gui_p->game_options_2.but_f_click, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_CLICK) ) );

	EG_Button_SetCaption(gui_p->game_options_2.but_f_a, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_A) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_f_b, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_B) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_f_x, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_X) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_f_y, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_Y) ) );

	EG_Button_SetCaption(gui_p->game_options_2.but_f_l, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_L) ) );
	EG_Button_SetCaption(gui_p->game_options_2.but_f_r, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_R) ) );

	EG_Button_SetCaption(gui_p->game_options_2.but_f_select, GameOptions2_GetKeyName( Keyboard_GetButtonMapping(GP2X_R_BUTTON_SELECT) ) );
...
static void GameOptions2_Callback_MapStickLeft(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_LEFT) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_left, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_LEFT, new_key);
	}
}
...
static void GameOptions2_Callback_MapStickRight(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_RIGHT) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_right, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_RIGHT, new_key);
	}
}
...
static void GameOptions2_Callback_MapStickUp(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_UP) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_up, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_UP, new_key);
	}
}
...
static void GameOptions2_Callback_MapStickDown(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_DOWN) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_down, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_DOWN, new_key);
	}
}
...
static void GameOptions2_Callback_MapStickClick(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_CLICK) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_click, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_CLICK, new_key);
	}
}
...
static void GameOptions2_Callback_MapA(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_A) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_a, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_A, new_key);
	}
}
...
static void GameOptions2_Callback_MapB(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_B) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_b, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_B, new_key);
	}
}
...
static void GameOptions2_Callback_MapX(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_X) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_x, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_X, new_key);
	}
}
...
static void GameOptions2_Callback_MapY(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_Y) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_y, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_Y, new_key);
	}
}

static void GameOptions2_Callback_MapL(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_L) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_l, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_L, new_key);
	}
}
static void GameOptions2_Callback_MapR(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_R) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_r, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_R, new_key);
	}
}

static void GameOptions2_Callback_MapSelect(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_SELECT) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_select, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_SELECT, new_key);
	}
}

static void GameOptions2_Callback_MapVolUp(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_VOLUP) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_volup, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_VOLUP, new_key);
	}
}

static void GameOptions2_Callback_MapVolDown(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_BUTTON_VOLDOWN) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_voldown, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_BUTTON_VOLDOWN, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_StickLeft(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_LEFT) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_left, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_LEFT, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_StickRight(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_RIGHT) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_right, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_RIGHT, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_StickUp(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_UP) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_up, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_UP, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_StickDown(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_DOWN) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_down, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_DOWN, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_StickClick(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_CLICK) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_click, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_CLICK, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_A(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_A) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_a, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_A, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_B(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_B) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_b, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_B, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_X(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_X) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_x, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_X, new_key);
	}
}
...
static void GameOptions2_Callback_Map_F_Y(EG_Widget*, void* user_p)
{
	...
	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_Y) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_y, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_Y, new_key);
	}
}

static void GameOptions2_Callback_Map_F_L(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_L) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_l, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_L, new_key);
	}
}
static void GameOptions2_Callback_Map_F_R(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_R) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_r, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_R, new_key);
	}
}

static void GameOptions2_Callback_Map_F_Select(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_SELECT) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_select, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_SELECT, new_key);
	}
}

static void GameOptions2_Callback_Map_F_VolUp(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_VOLUP) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_volup, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_VOLUP, new_key);
	}
}

static void GameOptions2_Callback_Map_F_VolDown(EG_Widget*, void* user_p)
{
	BeebEm_Pages *gui_p = (BeebEm_Pages*) user_p;
	int new_key;

	new_key = BBCKeyboard_Show( EG_Window_GetSurface(gui_p->game_options_2.win) , Keyboard_GetButtonMapping(GP2X_R_BUTTON_VOLDOWN) );

	if (new_key>=0) {
		EG_Button_SetCaption(gui_p->game_options_2.but_f_voldown, GameOptions2_GetKeyName(new_key) );
		Keyboard_SetKey(GP2X_R_BUTTON_VOLDOWN, new_key);
	}
}
...
//	r = (SDL_Rect) {8, 4, GUI_WIDTH-16, GUI_HEIGHT-8};
	...
	gui_p->game_options_2.lbl = EG_Label_Create("game_options_2_lbl", EG_COLOR_ALT
	 , EG_LABEL_ALIGN_CENTER, "Normal mode buttons:", C_1_1(r2, 22, 2));
	...
	gui_p->game_options_2.lbl_a = EG_Label_Create("game_options_2_a_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "A", C_1_4(r3, 5, 2));
	...
	gui_p->game_options_2.lbl_b = EG_Label_Create("game_options_2_b_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "B", C_2_4(r3, 5, 2));
	...
	gui_p->game_options_2.lbl_x = EG_Label_Create("game_options_2_x_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "X", C_3_4(r3, 5, 2));
	...
	gui_p->game_options_2.lbl_y = EG_Label_Create("game_options_2_y_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "Y", C_4_4(r3, 5, 2));
	 ...
	 * <Key name>   <Key name>      <Key name>      <Key name>
	 */
	gui_p->game_options_2.lbl_l = EG_Label_Create("game_options_2_l_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "L", C_1_4(r3, 9, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_l);
	nr=C_1_4(r3, 11, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_l = EG_Button_Create("game_options_2_l_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_l, GameOptions2_Callback_MapL, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_l);

	gui_p->game_options_2.lbl_r = EG_Label_Create("game_options_2_r_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "R", C_2_4(r3, 9, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_r);
	nr=C_2_4(r3, 11, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_r = EG_Button_Create("game_options_2_r_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_r, GameOptions2_Callback_MapR, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_r);

	gui_p->game_options_2.lbl_select = EG_Label_Create("game_options_2_select_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "SELECT", C_3_4(r3, 9, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_select);
	nr=C_3_4(r3, 11, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_select = EG_Button_Create("game_options_2_select_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_select, GameOptions2_Callback_MapSelect, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_select);

	gui_p->game_options_2.lbl_click = EG_Label_Create("game_options_2_click_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "CLICK", C_4_4(r3, 9, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_click);
	nr=C_4_4(r3, 11, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_click = EG_Button_Create("game_options_2_click_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_click, GameOptions2_Callback_MapStickClick, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_click);

	/* Volume Up	Volume Down
	 * <Key name>	<Key name>
 	 */
	gui_p->game_options_2.lbl_voldown = EG_Label_Create("game_options_2_voldown_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "VOL-", C_2_4(r3, 13, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_voldown);
	nr=C_2_4(r3, 15, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_voldown = EG_Button_Create("game_options_2_voldown_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_voldown, GameOptions2_Callback_MapVolDown, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_voldown);

	gui_p->game_options_2.lbl_volup = EG_Label_Create("game_options_2_volup_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "VOL+", C_1_4(r3, 13, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_volup);
	nr=C_1_4(r3, 15, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_volup = EG_Button_Create("game_options_2_volup_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_volup, GameOptions2_Callback_MapVolUp, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_volup);
	...
	gui_p->game_options_2.lbl_f = EG_Label_Create("game_options_2_lbl_f", EG_COLOR_ALT
	 , EG_LABEL_ALIGN_CENTER, "Flipped mode buttons:", C_1_1(r2, 1, 2));
	...
	// <Key name>   <Key name>      <Key name>      <Key name>
	//
	gui_p->game_options_2.lbl_f_l = EG_Label_Create("game_options_2_f_l_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "L", C_1_4(r3, 9, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_f_l);
	nr=C_1_4(r3, 11, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_f_l = EG_Button_Create("game_options_2_f_l_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_f_l, GameOptions2_Callback_Map_F_L, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_f_l);

	gui_p->game_options_2.lbl_f_r = EG_Label_Create("game_options_2_f_r_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "R", C_2_4(r3, 9, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_f_r);
	nr=C_2_4(r3, 11, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_f_r = EG_Button_Create("game_options_2_f_r_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_f_r, GameOptions2_Callback_Map_F_R, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_f_r);

	gui_p->game_options_2.lbl_f_select = EG_Label_Create("game_options_2_f_select_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "SELECT", C_3_4(r3, 9, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_f_select);
	nr=C_3_4(r3, 11, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_f_select = EG_Button_Create("game_options_2_f_select_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_f_select, GameOptions2_Callback_Map_F_Select, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_f_select);

	gui_p->game_options_2.lbl_f_click = EG_Label_Create("game_options_2_f_click_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "CLICK", C_4_4(r3, 9, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_f_click);
	nr=C_4_4(r3, 11, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_f_click = EG_Button_Create("game_options_2_f_click_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_f_click, GameOptions2_Callback_Map_F_StickClick, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_f_click);

	// Volume Up	Volume Down
	// <Key name>	<Key name>
 	//
	gui_p->game_options_2.lbl_f_voldown = EG_Label_Create("game_options_2_f_voldown_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "VOL-", C_2_4(r3, 13, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_f_voldown);
	nr=C_2_4(r3, 15, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_f_voldown = EG_Button_Create("game_options_2_f_voldown_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_f_voldown, GameOptions2_Callback_Map_F_VolDown, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_f_voldown);

	gui_p->game_options_2.lbl_f_volup = EG_Label_Create("game_options_2_f_volup_lbl", c
	 , EG_LABEL_ALIGN_CENTER, "VOL+", C_1_4(r3, 13, 2));
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.lbl_f_volup);
	nr=C_1_4(r3, 15, 2); nr.y-=2; nr.h+=3; gui_p->game_options_2.but_f_volup = EG_Button_Create("game_options_2_f_volup_but", c
	 , EG_BUTTON_ALIGN_CENTER, "NOTHING", nr );
	(void) EG_Button_SetMyCallback_OnClick(gui_p->game_options_2.but_f_volup, GameOptions2_Callback_Map_F_VolUp, gui_p);
	(void) EG_Window_AddWidget(gui_p->game_options_2.win, gui_p->game_options_2.but_f_volup);
...
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_left		, gui_p->game_options_2.but_f_volup);
...
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_right		, gui_p->game_options_2.but_f_voldown);
...
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_up		, gui_p->game_options_2.but_f_select);
...
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_down		, gui_p->game_options_2.but_f_click);
...
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_a		, gui_p->game_options_2.but_l);
...
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_b		, gui_p->game_options_2.but_r);
...
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_x		, gui_p->game_options_2.but_select);
...
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_y		, gui_p->game_options_2.but_click);


EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.but_l		, gui_p->game_options_2.but_r);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_l		, gui_p->game_options_2.but_a);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_l		, gui_p->game_options_2.but_volup);

EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_r		, gui_p->game_options_2.but_l);
EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.but_r		, gui_p->game_options_2.but_select);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_r		, gui_p->game_options_2.but_b);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_r		, gui_p->game_options_2.but_voldown);

EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_select	, gui_p->game_options_2.but_r);
EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.but_select	, gui_p->game_options_2.but_click);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_select		, gui_p->game_options_2.but_x);

EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_click		, gui_p->game_options_2.but_select);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_click		, gui_p->game_options_2.but_y);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_click		, gui_p->game_options_2.but_back);


EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.but_volup	, gui_p->game_options_2.but_voldown);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_volup		, gui_p->game_options_2.but_l);
//EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_volup		, gui_p->game_options_2.but_stick);

EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_voldown	, gui_p->game_options_2.but_volup);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_voldown		, gui_p->game_options_2.but_r);
//EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_voldown	, gui_p->game_options_2.but_stick);
...
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_a		, gui_p->game_options_2.but_f_l);
...
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_b		, gui_p->game_options_2.but_f_r);
...
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_x		, gui_p->game_options_2.but_f_select);
...
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_y		, gui_p->game_options_2.but_f_click);


EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.but_f_l		, gui_p->game_options_2.but_f_r);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_f_l		, gui_p->game_options_2.but_f_a);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_l		, gui_p->game_options_2.but_f_volup);

EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_f_r		, gui_p->game_options_2.but_f_l);
EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.but_f_r		, gui_p->game_options_2.but_f_select);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_f_r		, gui_p->game_options_2.but_f_b);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_r		, gui_p->game_options_2.but_f_voldown);

EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_f_select	, gui_p->game_options_2.but_f_r);
EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.but_f_select	, gui_p->game_options_2.but_f_click);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_f_select	, gui_p->game_options_2.but_f_x);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_select	, gui_p->game_options_2.but_up);

EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_f_click	, gui_p->game_options_2.but_f_select);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_f_click		, gui_p->game_options_2.but_f_y);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_click	, gui_p->game_options_2.but_down);


EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.but_f_volup	, gui_p->game_options_2.but_f_voldown);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_f_volup		, gui_p->game_options_2.but_f_l);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_volup	, gui_p->game_options_2.but_left);

EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_f_voldown	, gui_p->game_options_2.but_f_volup);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_f_voldown	, gui_p->game_options_2.but_f_r);
EG_Widget_SetSmartFocusPeerDown(gui_p->game_options_2.but_f_voldown	, gui_p->game_options_2.but_right);

//EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.tck_flipped			, gui_p->game_options_2.but_volup);

//EG_Widget_SetSmartFocusPeerRight(gui_p->game_options_2.tck_flipped	, gui_p->game_options_2.but_back);

//EG_Widget_SetSmartFocusPeerLeft(gui_p->game_options_2.but_back		, gui_p->game_options_2.but_stick);
EG_Widget_SetSmartFocusPeerUp(gui_p->game_options_2.but_back		, gui_p->game_options_2.but_click);
