...
{
        if (!strcasecmp (name, "LEFT")) return GP2X_BUTTON_LEFT;
        if (!strcasecmp (name, "RIGHT")) return GP2X_BUTTON_RIGHT;
        if (!strcasecmp (name, "UP")) return GP2X_BUTTON_UP;
        if (!strcasecmp (name, "DOWN")) return GP2X_BUTTON_DOWN;
        if (!strcasecmp (name, "A")) return GP2X_BUTTON_A;
        if (!strcasecmp (name, "B")) return GP2X_BUTTON_B;
	...
	if (!strcasecmp (name, "VOLDOWN")) return GP2X_BUTTON_VOLDOWN;

        if (!strcasecmp (name, "R_LEFT")) return GP2X_R_BUTTON_LEFT;
        if (!strcasecmp (name, "R_RIGHT")) return GP2X_R_BUTTON_RIGHT;
        if (!strcasecmp (name, "R_UP")) return GP2X_R_BUTTON_UP;
        if (!strcasecmp (name, "R_DOWN")) return GP2X_R_BUTTON_DOWN;
        if (!strcasecmp (name, "R_A")) return GP2X_R_BUTTON_A;
        if (!strcasecmp (name, "R_B")) return GP2X_R_BUTTON_B;
        if (!strcasecmp (name, "R_X")) return GP2X_R_BUTTON_X;
        if (!strcasecmp (name, "R_Y")) return GP2X_R_BUTTON_Y;
        if (!strcasecmp (name, "R_SELECT")) return GP2X_R_BUTTON_SELECT;
	if (!strcasecmp (name, "R_CLICK")) return GP2X_R_BUTTON_CLICK;
	if (!strcasecmp (name, "R_L")) return GP2X_R_BUTTON_L;
	if (!strcasecmp (name, "R_R")) return GP2X_R_BUTTON_R;
	if (!strcasecmp (name, "R_VOLUP")) return GP2X_R_BUTTON_VOLUP;
	if (!strcasecmp (name, "R_VOLDOWN")) return GP2X_R_BUTTON_VOLDOWN;
        return -1;
}
...
int kbd_load_mapping_file(FILE *KbdFile)
{
        ...
        gp2x_key_lookup[JOY_UP] = gp2xButtonToSDLK(GP2X_BUTTON_UP);
        gp2x_key_lookup[JOY_DOWN] = gp2xButtonToSDLK(GP2X_BUTTON_DOWN);
        gp2x_key_lookup[JOY_LEFT] = gp2xButtonToSDLK(GP2X_BUTTON_LEFT);
        gp2x_key_lookup[JOY_RIGHT] = gp2xButtonToSDLK(GP2X_BUTTON_RIGHT);
        gp2x_key_lookup[JOY_A] = gp2xButtonToSDLK(GP2X_BUTTON_A);
        gp2x_key_lookup[JOY_B] = gp2xButtonToSDLK(GP2X_BUTTON_B);
        gp2x_key_lookup[JOY_X] = gp2xButtonToSDLK(GP2X_BUTTON_X);
        gp2x_key_lookup[JOY_Y] = gp2xButtonToSDLK(GP2X_BUTTON_Y);
        gp2x_key_lookup[JOY_SELECT] = gp2xButtonToSDLK(GP2X_BUTTON_SELECT);

	gp2x_key_lookup[JOY_CLICK] = gp2xButtonToSDLK(GP2X_BUTTON_CLICK);
	gp2x_key_lookup[JOY_L] = gp2xButtonToSDLK(GP2X_BUTTON_L);
	gp2x_key_lookup[JOY_R] = gp2xButtonToSDLK(GP2X_BUTTON_R);
	gp2x_key_lookup[JOY_VOLUP] = gp2xButtonToSDLK(GP2X_BUTTON_VOLUP);
	gp2x_key_lookup[JOY_VOLDOWN] = gp2xButtonToSDLK(GP2X_BUTTON_VOLDOWN);

	// and upside down buttons:
        gp2x_key_lookup[R_JOY_UP] = gp2xButtonToSDLK(GP2X_R_BUTTON_UP);
        gp2x_key_lookup[R_JOY_DOWN] = gp2xButtonToSDLK(GP2X_R_BUTTON_DOWN);
        gp2x_key_lookup[R_JOY_LEFT] = gp2xButtonToSDLK(GP2X_R_BUTTON_LEFT);
        gp2x_key_lookup[R_JOY_RIGHT] = gp2xButtonToSDLK(GP2X_R_BUTTON_RIGHT);
        gp2x_key_lookup[R_JOY_A] = gp2xButtonToSDLK(GP2X_R_BUTTON_A);
        gp2x_key_lookup[R_JOY_B] = gp2xButtonToSDLK(GP2X_R_BUTTON_B);
        gp2x_key_lookup[R_JOY_X] = gp2xButtonToSDLK(GP2X_R_BUTTON_X);
        gp2x_key_lookup[R_JOY_Y] = gp2xButtonToSDLK(GP2X_R_BUTTON_Y);
        gp2x_key_lookup[R_JOY_SELECT] = gp2xButtonToSDLK(GP2X_R_BUTTON_SELECT);

	gp2x_key_lookup[R_JOY_CLICK] = gp2xButtonToSDLK(GP2X_R_BUTTON_CLICK);
	gp2x_key_lookup[R_JOY_L] = gp2xButtonToSDLK(GP2X_R_BUTTON_L);
	gp2x_key_lookup[R_JOY_R] = gp2xButtonToSDLK(GP2X_R_BUTTON_R);
	gp2x_key_lookup[R_JOY_VOLUP] = gp2xButtonToSDLK(GP2X_R_BUTTON_VOLUP);
	gp2x_key_lookup[R_JOY_VOLDOWN] = gp2xButtonToSDLK(GP2X_R_BUTTON_VOLDOWN);
        return 0;
}
