...
//	printf("[%s] [%s]\n", config.drive_0_path, buf);
	...
	/* Normal orientation buttons:
	 */
	fprintf(output, "# Normal buttons:\n");

	fprintf(output, "LEFT=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_LEFT)) );
	fprintf(output, "RIGHT=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_RIGHT)) );
	fprintf(output, "UP=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_UP)) );
	fprintf(output, "DOWN=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_DOWN)) );
	fprintf(output, "CLICK=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_CLICK)) );

	fprintf(output, "A=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_A)) );
	fprintf(output, "B=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_B)) );
	fprintf(output, "X=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_X)) );
	fprintf(output, "Y=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_Y)) );

	fprintf(output, "L=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_L)) );
	fprintf(output, "R=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_R)) );

	fprintf(output, "SELECT=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_BUTTON_SELECT)) );
	...
	/* Flipped orientation buttons:
	 */
	fprintf(output, "# Flipped buttons:\n");

	fprintf(output, "R_LEFT=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_LEFT)) );
	fprintf(output, "R_RIGHT=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_RIGHT)) );
	fprintf(output, "R_UP=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_UP)) );
	fprintf(output, "R_DOWN=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_DOWN)) );
	fprintf(output, "R_CLICK=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_CLICK)) );

	fprintf(output, "R_A=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_A)) );
	fprintf(output, "R_B=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_B)) );
	fprintf(output, "R_X=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_X)) );
	fprintf(output, "R_Y=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_Y)) );

	fprintf(output, "R_L=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_L)) );
	fprintf(output, "R_R=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_R)) );

	fprintf(output, "R_SELECT=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_SELECT)) );

	fprintf(output, "R_VOLUP=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_VOLUP)) );
	fprintf(output, "R_VOLDOWN=%s\n", Keyboard_GetKeyName(Keyboard_GetButtonMapping(GP2X_R_BUTTON_VOLDOWN)) );
	fprintf(output, "\n");
